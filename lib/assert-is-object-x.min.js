 ...
 */
"use strict";var safeToString=_dereq_("to-string-symbols-supported-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsObject(value){if(isPrimitive(value))throw new TypeError(safeToString(value)+" is not an object");return value}},{"is-primitive":4,"to-string-symbols-supported-x":6}],2:[function(_dereq_,module,exports){/**
